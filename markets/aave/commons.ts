...
export const CommonsConfig: ICommonConfiguration = {
  ...
  ProtocolGlobalParams: {
    ...
    UsdAddress: '0x10F7Fc1F91Ba351f9C629c5947AD69bD03C05b96', //kovan有
  ...
  ProviderRegistry: {
    ...
    [eEthereumNetwork.kovan]: '0xbC7Fe19757b45b7821Ea56Ab7d145FFE1Fa23DE4', //TODO duke:: 如果不填写，会自动创建新的
  ...
  ProviderRegistryOwner: {
    [eEthereumNetwork.kovan]: '0xEf884C06F2aBf71040ff28976E3a85DDa8813ab2', //这个和ProviderRegistry是联动的 duke
    [eEthereumNetwork.ropsten]: '',
  ...
  LendingRateOracle: {
    ...
    [eEthereumNetwork.hardhat]: '',
    [eEthereumNetwork.buidlerevm]: '',
    // [eEthereumNetwork.kovan]: '0xdCde9Bb6a49e37fA433990832AB541AE2d4FEB4a', 官方的
    [eEthereumNetwork.kovan]: '', //TODO 填空时，自动使用：LendingRateOracleRatesCommon
  ...
  LendingPoolCollateralManager: {
    ...
    [eEthereumNetwork.hardhat]: '',
    [eEthereumNetwork.buidlerevm]: '',
    // [eEthereumNetwork.kovan]: '0x9269b6453d0d75370c4c85e5a42977a53efdb72a', 官方
    [eEthereumNetwork.kovan]: '0x0E5914f696965cA1a7eCdfa17738EE28dCEb3c5D', //TODO duke 自己填写
    [eEthereumNetwork.ropsten]: '',
  ...
  LendingPoolConfigurator: {
    //TODO 这是imp的地址与实例是两个地址,json中的是实例
    //只有部署了才会出现在json文件中
    [eEthereumNetwork.coverage]: '',
    [eEthereumNetwork.hardhat]: '',
    [eEthereumNetwork.buidlerevm]: '',
    [eEthereumNetwork.kovan]: '0xE246D9c2dFF32DF7ee8129122BCAc2f858B7c95f', //TODO duke 自己填写
    [eEthereumNetwork.ropsten]: '',
  ...
  LendingPool: {
    ...
    [eEthereumNetwork.hardhat]: '',
    [eEthereumNetwork.buidlerevm]: '',
    [eEthereumNetwork.kovan]: '0x8f254f0358Bd7814672A98ebBb11491681dd1f94', //TODO duke 自己填写
    [eEthereumNetwork.ropsten]: '',
    [eEthereumNetwork.main]: '',
    [eEthereumNetwork.tenderly]: '',
  },
  ...
  TokenDistributor: {
    ...
    [eEthereumNetwork.buidlerevm]: '',
    [eEthereumNetwork.hardhat]: '',
    // [eEthereumNetwork.kovan]: '0x971efe90088f21dc6a36f610ffed77fc19710708', duke
    [eEthereumNetwork.kovan]: '',
  ...
  AaveOracle: { //TODO 这个是什么？
    [eEthereumNetwork.coverage]: '',
    [eEthereumNetwork.hardhat]: '',
    [eEthereumNetwork.buidlerevm]: '',
    // [eEthereumNetwork.kovan]: '', //'0xB8bE51E6563BB312Cbb2aa26e352516c25c26ac1',
    [eEthereumNetwork.kovan]: '0x4578344f10246e3dc96b7D2c6E7854fF3798678A', //TODO duke 自己填写 
  ...
  ChainlinkAggregator: { //TODO需要在这里修改价格
    [eEthereumNetwork.coverage]: {},
    [eEthereumNetwork.hardhat]: {},
    [eEthereumNetwork.buidlerevm]: {},
    /* //TODO 这是官方的kovan数据
    [eEthereumNetwork.kovan]: {
      ...
      DAI: '0x22B58f1EbEDfCA50feF632bD73368b2FdA96D541', //用自己的DAI，但是使用kovan官方的预言机
    ...
    */
    ...
    [eEthereumNetwork.kovan]: {
      DAI: '0x8a40f7E2c2E9Fa3d9aDced37f9b6949F30df8A33', //用自己的DAI，但是使用kovan官方的预言机
      MKR: '0x7b6eb79E10085056232E2be9A41339899065334e',
      LINK: '0x4f8B341B5CDB526fE0ec6e0F0FA6D2D1A97aBAc5',
      WBTC: '0x0b93B7dcf417E4A43318bB2699c3e7475A9D3501',
      USDT: '0xb32A04349b17cCD92055CF72674aD507F9826cb3',
      USDC: '0xE0FA13BF2A83Cf2deb7cD2B83443b4846ecC2988',
  ...
  ReserveFactorTreasuryAddress: {
    ...
    // [eEthereumNetwork.kovan]: '0x464c71f6c2f760dda6093dcb91c24c39e5d6e18c', //官方地址
    [eEthereumNetwork.kovan]: '0xEf884C06F2aBf71040ff28976E3a85DDa8813ab2', //TODO duke 自己的地址
