...
export const MOCK_CHAINLINK_AGGREGATORS_PRICES = {
  ...
  CHFRYBAT: oneEther.multipliedBy('0.00137893825230').toFixed(),
...
//上下两处都要修改成自己的: chainlinkEthUsdAggregatorProxy
export const chainlinkAggregatorProxy = {
  main: '0x5f4eC3Df9cbd43714FE2740f5E3616155c5b8419',
  // kovan: '0x9326BFA02ADD2366b30bacB125260Af641031331', 官方的
  // kovan: '0x6C295b6D643a8750C4A903716eFc0B7Ce4A04eed', //活动使用的
  kovan: '0x9cc0EF674A21f964D2E74Ab7b8B3911C3B64Be42', //TODO duke 自己部署的，ETH/USD价格，给前端使用, 400000000000, 8位
...
//TODO duke //上下两处都要修改成自己的: chainlinkAggregatorProxy
